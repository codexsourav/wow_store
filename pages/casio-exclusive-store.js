                  ...
                  <div className="wowDtlsContent">
                    ...
                    <ul>
                      ...
                      <li className="callWithWatsapp">
                        <div className="whatsapp"><a href="https://wa.me/918076063649?text=Hello%20Wow">8076063649</a></div>
              ...
              <div className="col-lg-6 pe-lg-0">
                <div className="customOwlnav bottomPosition">
                  <div className="owl-carousel topSlider owl-theme">
                    <div className="item">
                      <img src="https://bonwic.cloud/wow/casio-exclusive-store/img/banner.webp" className="w-100" />
                    </div>
                    <div className="item">
                      <img src="https://bonwic.cloud/wow/casio-exclusive-store/img/banner2.webp" className="w-100" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="customOwlnav topLessPosition rightPostiont">
                  <div className="owl-carousel brandSlider owl-theme">
                    <div className="brandItmes">
                      <img src="https://bonwic.cloud/wow/casio-exclusive-store/img/brand1.webp" />
                    </div>
                    <div className="brandItmes">
                      <img src="https://bonwic.cloud/wow/casio-exclusive-store/img/brand2.webp" />
                    </div>
                    <div className="brandItmes">
                      <img src="https://bonwic.cloud/wow/casio-exclusive-store/img/brand3.webp" />
                    </div>
                    <div className="brandItmes">
                      <img src="https://bonwic.cloud/wow/casio-exclusive-store/img/brand4.webp" />
                    </div>
                    <div className="brandItmes">
                      <img src="https://bonwic.cloud/wow/casio-exclusive-store/img/brand5.webp" />
                    </div>
                    <div className="brandItmes">
                      <img src="https://bonwic.cloud/wow/casio-exclusive-store/img/brand6.webp" />
                    </div>
                    <div className="brandItmes">
                      <img src="https://bonwic.cloud/wow/casio-exclusive-store/img/brand7.webp" />
                    </div>
                    <div className="brandItmes">
                      <img src="https://bonwic.cloud/wow/casio-exclusive-store/img/brand8.webp" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="curveBg">
            <div className="customOwlnav bottomPosition">
              <div className="owl-carousel casioSlider owl-theme">
                <div className="item">
                  <img src="https://bonwic.cloud/wow/casio-exclusive-store/img/s1.webp" className="w-100" />
                </div>
                <div className="item">
                  <img src="https://bonwic.cloud/wow/casio-exclusive-store/img/s2.webp" className="w-100" />
                </div>
                <div className="item">
                  <img src="https://bonwic.cloud/wow/casio-exclusive-store/img/s3.webp" className="w-100" />
                </div>
                <div className="item">
                  <img src="https://bonwic.cloud/wow/casio-exclusive-store/img/s4.webp" className="w-100" />
                </div>
                <div className="item">
                  <img src="https://bonwic.cloud/wow/casio-exclusive-store/img/s5.webp" className="w-100" />
                </div>     
              </div>
            </div>
          </div>
