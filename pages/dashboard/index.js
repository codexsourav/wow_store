          ...
          <div className={classes.card}>
            <div className={classes.circle}>
              <div className={classes.circle_inner}>
                ...
                <div className={classes.label}>Total Order</div>
          ...
          <div className={classes.card}>
            <div className={classes.circle}>
              <div className={classes.circle_inner}>
                ...
                <div className={classes.label}>Total Customer</div>
                <div className={classes.color}></div>
              </div>
            </div>
          </div>
          <div className={classes.card}>
            <div className={classes.circle}>
              <div className={classes.circle_inner}>
                ...
                <div className={classes.label}>Total Category</div>
                <div className={classes.color}></div>
              </div>
            </div>
          </div>
          <div className={classes.card}>
            <div className={classes.circle}>
              <div className={classes.circle_inner}>
                ...
                <div className={classes.label}>Total Color</div>
                <div className={classes.color}></div>
              </div>
            </div>
          </div>
          <div className={classes.card}>
            <div className={classes.circle}>
              <div className={classes.circle_inner}>
                ...
                <div className={classes.label}>Total Attribute</div>
                <div className={classes.color}></div>
              </div>
            </div>
          </div>
          <div className={classes.card}>
            <div className={classes.circle}>
              <div className={classes.circle_inner}>
                ...
                <div className={classes.label}>Total Coupon</div>
                <div className={classes.color}></div>
              </div>
            </div>
          </div>
