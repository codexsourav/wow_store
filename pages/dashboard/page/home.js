...
const HomePageSetting = () => {
  ...
  function banner() {
    return (
      <div className="card border-0 shadow mb-5">
        <div className="card-header bg-white py-3 fw-bold">Banner</div>
        <div className="card-body">
          <form onSubmit={handleBannerAdd}>
            <div className="pb-0">
              <FileUpload
                accept=".jpg,.png,.jpeg"
                label="Image(1920px x 750px)*"
                maxFileSizeInBytes={2000000}
  ...
  function headerCarousel() {
    return (
      <div className="card border-0 shadow mb-5">
        <div className="card-header bg-white py-3 fw-bold">Header carousel</div>
        <div className="card-body">
          <DataTable
            columns={columns}
          ...
          {permissions.edit && (
            <>
              <Accordion title="Add new header carousel item">
                <form onSubmit={handleCarouselAdd} ref={carouselForm}>
                  <div className="pb-0">
                    <FileUpload
                      accept=".jpg,.png,.jpeg"
                      label="Image(750px x 750px)*"
                      maxFileSizeInBytes={2000000}
              ...
              <Accordion title="Header carousel background">
                <div className="pb-0">
                  <FileUpload
                    accept=".jpg,.png,.jpeg"
                    label="Image(1920px x 800px)*"
                    maxFileSizeInBytes={2000000}
