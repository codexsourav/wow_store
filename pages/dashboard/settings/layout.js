...
const SettingsPageLayout = () => {
  ...
  function footerSettings() {
    return (
      <div className="card mb-5 border-0 shadow">
        <div className="card-header bg-white py-3 fw-bold">Footer Settings</div>
        <div className="card-body">
          <div className="py-3">
  ...
  function footerBannerSettings() {
    return (
      <div className="card mb-5 border-0 shadow">
        <div className="card-header bg-white py-3 fw-bold">Footer Widget</div>
        <div className="card-body">
          <div className="py-3">
  ...
  function headerSettings() {
    return (
      <div className="card mb-5 border-0 shadow">
        <div className="card-header bg-white py-3 fw-bold">Header Settings</div>
        <div className="card-body">
          <div className="py-3">
