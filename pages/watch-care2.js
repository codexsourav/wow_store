...
11
 ...
 <section className="watchCareInfo  pt-5">
    ...
    <p className='normText text-center py-3'>We know that you enjoy taking care of your watches just as much as you relish wearing them. 
		  			...
		  			<ul className={`mt-4 ${c.gridGallery}`}>
		  			{
		  				...
		  				<li>
		  					...
		  					<div className={c.captionText}>
		  							...
		  							<p className={c.tag}>As a global textile and healthcare leader</p>
		  					</div>
		  				</li>
		  				<li><img src="images/about-3.png" />
		  					<div className={c.captionText}>
		  							<h2>Leadership</h2>
		  							<p className={c.tag}>As a global textile and healthcare leader</p>
		  					</div>
		  				</li>
		  				<li><img src="images/about-4.png" />
		  					<div className={c.captionText}>
		  								<h2><span>Established</span> <span>in 1977</span></h2>
		  							<h2>History</h2>
		  							<p className={c.tag}>As a global textile and healthcare leader</p>
		  					</div>
		  				</li>
		  				<li><img src="images/about-5.png" />
		  					<div className={c.captionText}>
		  							<h2>Vision</h2>
		  							<p className={c.tag}>As a global textile and healthcare leader</p>
		  					</div>
		  				</li>
		  				<li><img src="images/about-6.png" />
		  					<div className={c.captionText}>
		  							<h2>Mission</h2>
		  						<p className={c.tag}>As a global textile and healthcare leader</p>
		  					</div>
		  				</li>
		  				<li><img src="images/about-7.png" />
		  					<div className={c.captionText}>
		  							<h2>Celebrity</h2>
		  							<p className={c.tag}>As a global textile and healthcare leader</p>
		  					</div>
