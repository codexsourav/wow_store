   ...
   <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet" />
        ...
        <section className="topBanner">
          <div className="container-fluid">
            ...
            <div class="subName">MGF Metropolitan Mall (First Floor)</div>
            <ul>
              <li class="location">Shop 41, First floor, MGF Metropolitan Mall, M.G. Road, Gurugram, Haryana 122002</li>
             <li class="mail"><a href="mailto:wow41.gur@outlook.com" class="mail-icon">wow41.gur@outlook.com</a></li>
              <li class="callWithWatsapp">
                <div class="whatsapp"><a href="https://wa.me/918448338687?text=Hello%20Worldmark">8448338687</a></div>
                <div class="call"><a href="tel:0124 4016751">0124-4016751</a></div>
              </li>
            </ul>
          </div>
                  <div className="btnDtls">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#directionmodal" className="wowBtn">Get Direction</a>
                    <a href="tel:8448338684" className="wowBtn">Call Now</a>
              ...
              <div className="col-lg-6 pe-lg-0">
                <div className="customOwlnav bottomPosition">
                  <div className="owl-carousel topSlider owl-theme">
                    <div className="item">
                      <img src="https://bonwic.cloud/wow/mgf-first-floor/img/banner.webp" className="w-100" />
                    </div>
                    <div className="item">
                      <img src="https://bonwic.cloud/wow/mgf-first-floor/img/banner2.webp" className="w-100" />
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/brand1.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/brand2.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/brand3.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/brand4.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/brand5.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/brand6.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/brand7.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/brand8.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/brand9.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/brand10.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/brand11.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/brand12.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/brand13.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/brand14.webp" />
        </div>
      </div>
                </div>
              </div>
		...
		<p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
          ...
          <div className="curveBg">
            ...
            <div className="item">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/s1.webp" className="w-100" />
        </div>
        <div className="item">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/s2.webp" className="w-100" />
        </div>
        <div className="item">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/s3.webp" className="w-100" />
        </div>
        <div className="item">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/s4.webp" className="w-100" />
        </div>
        <div className="item">
          <img src="https://bonwic.cloud/wow/mgf-first-floor/img/s5.webp" className="w-100" />
        </div>    
              </div>
            </div>
          </div>
          ...
          <div className="row flex-row-reverse">
            <div className="col-lg-6">
              <ul className="nav nav-tabs" id="myTab" role="tablist">
                <li className="nav-item" role="presentation">
                  <a className="nav-link active" id="mgfFirstFloor-tab" data-bs-toggle="tab" data-bs-target="#mgfFirstFloor-tab-pane" type="button" role="tab" aria-controls="mgfFirstFloor-tab-pane" aria-selected="false">
            ...
            <div className="col-lg-6">
              <div className="tab-content" id="myTabContent">
                ...
                <div className="tab-pane fade show active" id="mgfFirstFloor-tab-pane" role="tabpanel" aria-labelledby="mgfFirstFloor-tab" tabIndex={0}>
