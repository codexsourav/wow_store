...
export default function Worldmark2({children2}){
  ...
  return (
   ...
   <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet" />
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="wowDtls">
                 ...
                 <div class="wowDtlsContent">
            <h1>World of watches</h1>
            <div class="subName">MGF Metropolitan Mall, (Ground Floor)</div>
            <ul>
              <li class="location">Shop no. 77 &77A, Ground floor, MGF Metropolitan Mall, M.G. Road, Gurugram, Haryana 122002</li>
               <li class="mail"><a href="mailto:wow77.gurgaon@outlook.com" class="mail-icon">wow77.gurgaon@outlook.com</a></li>
              
              <li class="callWithWatsapp">
                <div class="whatsapp"><a href="https://wa.me/918448338684?text=Hello%20Worldmark">8448338684</a></div>
                <div class="call"><a href="tel:0124 4239329">0124-4239329</a></div>
              </li>
            </ul>
          </div>
          <div class="btnDtls">
            <a href="#" data-bs-toggle="modal" data-bs-target="#directionmodal" class="wowBtn">Get Direction</a>
            <a href="tel:8448338684" class="wowBtn">Call Now</a>
            <a href="#" data-bs-toggle="modal" data-bs-target="#bookappointment" class="wowBtn">Book Appointment</a>
                  </div>
                </div>
              </div>
              <div className="col-lg-6 pe-lg-0">
                <div className="customOwlnav bottomPosition">
                  <div className="owl-carousel topSlider owl-theme">
                    <div className="item">
                      <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/banner.webp" className="w-100" />
                    </div>
                    <div className="item">
                      <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/banner2.webp" className="w-100" />
                    </div>
                  </div>
                </div>
              </div>
       ...
       <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/brand1.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/brand2.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/brand3.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/brand4.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/brand5.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/brand6.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/brand7.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/brand8.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/brand9.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/brand10.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/brand11.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/brand12.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/brand13.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/brand14.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/brand15.webp" />
        </div>
        <div className="brandItmes">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/brand16.webp" />
        </div>
      </div>
                </div>
              </div>
       ...
       <div className="item">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/s1.webp" className="w-100" />
        </div>
        <div className="item">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/s2.webp" className="w-100" />
        </div>
        <div className="item">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/s3.webp" className="w-100" />
        </div>
        <div className="item">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/s4.webp" className="w-100" />
        </div>
        <div className="item">
          <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/s5.webp" className="w-100" />
        </div>   
              </div>
            </div>
          </div>
          ...
          <div className="row flex-row-reverse">
            <div className="col-lg-6">
              <ul className="nav nav-tabs" id="myTab" role="tablist">
                <li className="nav-item " role="presentation">
                  <a className="nav-link active" id="mgfGroundFloor-tab" data-bs-toggle="tab" data-bs-target="#mgfGroundFloor-tab-pane" type="button" role="tab" aria-controls="mgfGroundFloor-tab-pane" aria-selected="false">
            ...
            <div className="col-lg-6">
              <div className="tab-content" id="myTabContent">
                ...
                <div className="tab-pane fade show active" id="mgfGroundFloor-tab-pane" role="tabpanel" aria-labelledby="mgfGroundFloor-tab" tabIndex={0}>
              ...
              <div className="modal-body">
                <div className="row">
                  <div className="col-lg-6 pe-0 img-column">
                    <img src="https://bonwic.cloud/wow/mgf-ground-floor/img/model.webp" className="img-fluid model-img" />
                  </div>
