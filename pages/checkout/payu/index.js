...
//This method will generate the hashvalue
  ...
  const reshash = await axios.post("/api/checkout/payu", JSON.stringify(Subdata),
  ...
  return (
   ...
   <form method="post" name="redirect" ref={paymentForm} onSubmit={handelFormSubmit}  action='https://secure.payu.in/_payment' >
